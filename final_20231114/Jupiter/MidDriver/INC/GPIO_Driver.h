...
#define SPI0_CS1_GPIO_Port GPIO1
#define SPI0_CS1_WritePin GPIO1_1

#define RF1_CHIPEN_Pin GPIO_PIN_2
#define RF1_CHIPEN_GPIO_Port GPIO0
#define RF1_CHPIEN_WritePin GPIO0_2

#define RF1_PWEN_Pin GPIO_PIN_0
#define RF1_PWEN_GPIO_Port GPIO0
#define RF1_PWEN_WritePin GPIO0_0


//RF2   CS CHIPEN  PWEN 
#define SPI0_CS2_Pin GPIO_PIN_12
#define SPI0_CS2_GPIO_Port GPIO0
#define SPI0_CS2_WritePin GPIO0_12

//#define RF2_CHIPEN_Pin GPIO_PIN_10
//#define RF2_CHIPEN_GPIO_Port GPIO0
//#define RF2_CHPIEN_WritePin GPIO0_10

#define RF2_PWEN_Pin GPIO_PIN_9
#define RF2_PWEN_GPIO_Port GPIO0
#define RF2_PWEN_WritePin GPIO0_9


#define LED2_Pin GPIO_PIN_7
#define LED2_GPIO_Port GPIO0
#define LED2_WritePin GPIO0_7

#define LED3_Pin GPIO_PIN_8
#define LED3_GPIO_Port GPIO0
#define LED3_WritePin GPIO0_8


#define FIRE_Pin GPIO_PIN_10
#define FIRE_GPIO_Port GPIO0
#define FIRE_WritePin GPIO0_10

#define START_Pin             GPIO_PIN_6
#define START_GPIO_Port GPIO0
#define START_WritePin     GPIO0_3

#define FIRE_LOW_Pin GPIO_PIN_5
#define FIRE_LOW_GPIO_Port GPIO0
#define FIRE_LOW_WritePin GPIO0_5
